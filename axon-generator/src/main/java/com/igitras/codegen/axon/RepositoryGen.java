 ...
 */
public class RepositoryGen extends BaseGen {

    private static final String SUFFIX = ".entry.repository";
    private static final String CLASS_NAME_SUFFIX = "EntryRepository";
    ...
    public String getName() {
        return repositoryName + CLASS_NAME_SUFFIX;
    }
