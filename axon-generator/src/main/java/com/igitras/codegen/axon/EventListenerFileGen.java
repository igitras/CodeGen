 ...
 */
public class EventListenerFileGen extends BaseGen {

    private static final String SUFFIX = ".event.listener";
    private static final String CLASS_NAME_SUFFIX = "EventListener";
    ...
    public String getName() {
        return eventListenerName + CLASS_NAME_SUFFIX;
    }
