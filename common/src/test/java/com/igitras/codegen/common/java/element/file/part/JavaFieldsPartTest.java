...
public class JavaFieldsPartTest {
    ...
    public void testBuild() throws Exception {
        JavaFieldPart fieldPart = new JavaFieldPart(VisitPrivilege.PRIVATE, IsStatic.DEFAULT,
                IsFinal.DEFAULT, String.class.getName(), "testField", new JavaInitialPart());
        JavaFieldPart fieldPart2 = new JavaFieldPart(VisitPrivilege.PRIVATE, IsStatic.DEFAULT,
